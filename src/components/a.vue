<template>
  ...
  <div class="tabs">
    <ul>
      <li v-bind:class="{ 'is-active': isActive == 'pictures' }"><a v-on:click="isActive = 'pictures'">Pictures</a></li>
      <li v-bind:class="{ 'is-active': isActive == 'music' }"><a v-on:click="isActive = 'music'">Music</a></li>
